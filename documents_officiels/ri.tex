...
\label{sub:vacances_d_un_poste_et_modalites_de_remplacement}
			...
			%Le paragraphe suivant ne peut être inséré car est contradictoire avec les statuts qui stipulent la nécessité d'AGE
			
			%\paragraph{}Si le poste vacant est celui de président (respectivement
			%celui de trésorier) ce sera le vice-président (respectivement le vice
			%-trésorier)	qui prendra son poste sauf s'il refuse. Le poste de vice-
			%président (respectivement de vice-trésorier) deviendra donc vacant et
			%des élections seront organisées suivant les mêmes modalités que pour 
			%les autres postes.
